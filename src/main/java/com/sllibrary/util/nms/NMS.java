package com.sllibrary.util.nms;
...
public class NMS {
     ...
     */
    public static void registerItem(String name, int id, ItemStack item) {
        Item.REGISTRY.a(id, new MinecraftKey(name), CraftItemStack.asNMSCopy(item).getItem());
    }
    ...
    public static void registerEntity(Type type, Class<? extends Entity> customClass, boolean override) {
        NMS.registerEntity(type.getName(), type, customClass, override);
    }
    ...
    public enum MobMeta {
        MONSTER(NMS.META_LIST_MONSTER),
        CREATURE(NMS.META_LIST_CREATURE),
        WATER_CREATURE(NMS.META_LIST_WATER_CREATURE),
        AMBIENT(NMS.META_LIST_AMBIENT),
        UNDEFINED(null);
    ...
    static {
        ...
        try {
            ...
            Debugger.error(new IllegalAccessError(),"Wrong server version / software; BiomeMeta fields not found, aborting.");
        }
